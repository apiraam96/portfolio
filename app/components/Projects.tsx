          ...
          {projects.map((item) => (
            ...
            >
              <PinContainer title={item.link} href={item.link}>
                ...
                <h1 className="font-bold font-Roboto lg:text-2xl md:text-xl text-base line-clamp-1">
                  {item.title}
                </h1>

                <p
                  className="font-Roboto lg:text-lg lg:font-normal font-light text-sm line-clamp-2"
                  style={{
                    margin: "1vh 0",
                  }}
                >
