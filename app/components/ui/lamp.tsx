...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-12 items-center justify-center isolate z-0 ">
        <motion.div
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-purple opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
